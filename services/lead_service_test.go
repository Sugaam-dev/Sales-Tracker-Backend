...
func TestLeadLifecycleUpdate(t *testing.T) {
	...
	_, err = pool.Exec(ctx, `INSERT INTO leads (lead_id, company, contact, priority, stage, status, value, created_at, updated_at) VALUES
		('L-9999', 'Lifecycle Corp', 'Test Contact', 'High', 'Prospecting', 'Open', 50000.0, NOW(), NOW())`)
	if err != nil {
